...
import 'package:districtgroovejobs/CompanyCircle.dart';
import 'package:districtgroovejobs/CustomDrawer.dart';
import 'package:districtgroovejobs/DetailScreen.dart';
import 'package:districtgroovejobs/Job.dart';
import 'package:districtgroovejobs/utils/Colors.dart';
...
class _JobListScreenState extends State<JobListScreen> {
  ...
  Future<List<String>> getData() async {
    ...
    http.Response response = await http.get('https://districtgrooveapi.herokuapp.com/');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        actions: <Widget>[
          IconButton(
              icon: Icon(Icons.chat_bubble), color: Colors.white, onPressed: showAbout)
        ],
        elevation: 0.0,
